...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="left-content ">
            <div>
                <h6 class="mg-b-0">برنامج الفواتير لي تحصيل الديون</h6>
            </div>
        </div>
                        ...
                        <div class="d-flex">
                            ...
                            <span class="float-right my-auto mr-auto">
											...
											<span class="text-white op-7"> %
                                                ...
                                                @php
                                                $count_all=App\Models\Invoice::count();
                                                $invoices_paid=App\Models\Invoice::where('Value_Status',1)->count();
                        ...
                        <div class="d-flex">
                            ...
                            <span class="float-right my-auto mr-auto">
											...
											<span class="text-white op-7">%
                                                ...
                                                $count_all=App\Models\Invoice::count();
                                                $invoice_part_paid=App\Models\Invoice::where('Value_Status',3)->count();

                                                if ($invoice_part_paid==0)
                                                    echo $invoice_part_paid=0;
