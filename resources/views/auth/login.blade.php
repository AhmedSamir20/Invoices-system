            ...
            <div class="col-md-6 col-lg-6 col-xl-7 d-none d-md-flex bg-primary-transparent">
                <div class="row wd-100p mx-auto text-center">
                    <div class="col-md-12 col-lg-12 col-xl-12 my-auto mx-auto wd-100p">
                        {{--  <img src="{{URL::asset('assets/img/media/miii.jpg')}}" class="my-auto ht-xl-80p wd-md-100p wd-xl-80p mx-auto" alt="logo">  --}}
                        <img src="{{URL::asset('assets/img/media/mo.png')}}" class="my-auto ht-xl-100p wd-md-100p wd-xl-95p mx-auto" alt="logo">
                    </div>
                </div>
            </div>
