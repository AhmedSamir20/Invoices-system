			...
			<div class="main-sidemenu">
				...
				<ul class="side-menu">
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							<li><a class="slide-item" href="{{ url('/' . $page='chart-morris') }}">قائمه الفواتير</a></li>
							<li><a class="slide-item" href="{{ url('/' . $page='chart-flot') }}">الفواتير المدفعه</a></li>
							<li><a class="slide-item" href="{{ url('/' . $page='chart-chartjs') }}">الفواتير غير المدفعه</a></li>
							<li><a class="slide-item" href="{{ url('/' . $page='chart-echart') }}">الفواتير المدفعه جزئيا</a></li>
						</ul>
					</li>
