            ...
            @can('الفواتير')
                ...
                <li class="slide">
                    <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='#') }}">
                        ...
                        <span class="side-menu__label">الفواتير</span><i
                    ...
                    <ul class="slide-menu">
                        ...
                        @can('الفواتير الغير مدفوعة')
                            <li><a class="slide-item" href="{{ route('Invoice_UnPaid') }}">الفواتير غير المدفعه</a>
                            </li>
                        @endcan
                        @can('الفواتير المدفوعة جزئيا')
                            <li><a class="slide-item" href="{{ route('Invoice_Partial') }}">الفواتير المدفعه
                                    جزئيا</a></li>
                        @endcan
                        @can('ارشيف الفواتير')
            ...
            @can('الاعدادات')
                ...
                <li class="slide">
                    <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='#') }}">
                        ...
                        <span class="side-menu__label">الأعدادات</span><i class="angle fe fe-chevron-down"></i></a>
                    <ul class="slide-menu">
                        @can('الاقسام')
